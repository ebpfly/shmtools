...
class ParameterSchema:
    ...
    source_step: Optional[str] = None  # For variable references: "Step 1: function_name"
...
class StepSchema:
    ...
    status: str = 'pending'  # 'pending', 'configured', 'ready', 'running', 'completed', 'error'
...
class SessionSchema:
    ...
    def validate(self) -> List[str]:
        ...
        if sorted(actual_numbers) != expected_numbers:
            errors.append(f"Invalid step numbering: expected {expected_numbers}, got {actual_numbers}")
