            ...
            for nb_file in current_dir.glob('*.ipynb'):
                ...
                try:
                    with open(nb_file, 'r', encoding='utf-8') as f:
                        nb_content = f.read()
                        if 'dummy_function' in nb_content and 'summarize_discovered_parameters' in nb_content:
...
var1, var2 = dummy_function(inputA, inputB)'''
                ...
                {
                    'cell_type': 'code',
                    'source': 'summarize_discovered_parameters()'
                }
            ]
    ...
    if variables:
        ...
        for cell_name, vars_in_cell in by_cell.items():
            ...
            for var in vars_in_cell:
                print(f"     • {var['name']:<10} ({var['type']:<15}) ← {var.get('expression', 'N/A')[:30]}...")
    else:
