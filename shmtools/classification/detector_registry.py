...
class DetectorRegistry:
    ...
    def get_detector_info(
        ...
        if detector_name not in detectors:
            ...
            raise ValueError(
                f"Unknown {detector_type} detector: {detector_name}. "
    ...
    def validate_detector_availability(
        self, detector_type: str, detector_name: str
    ) -> bool:
        """
        ...
        """
        try:
            learn_func, score_func = self.get_function_pair(
    ...
    def get_function_signature(
        self, detector_type: str, detector_name: str, function_type: str
    ) -> inspect.Signature:
        """
